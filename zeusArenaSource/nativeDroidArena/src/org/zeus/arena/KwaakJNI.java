...
public class KwaakJNI {
	...
	public static native void enablePureServers(boolean enable);
	public static native void enableOpenArenaProtocol(boolean enable);
	...
	public static native void queueTouchEvent(int action, float x, float y, float pressure);
	public static native void queueTouchpadEvent(int action, float x, float y);
	public static native void queueTrackballEvent(int action, float x, float y);

	public static native void requestAudioData();
	
	public static native void setRenderer(KwaakRenderer renderer);
