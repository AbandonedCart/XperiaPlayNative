...
public class Help extends Activity{
	...
	public String getInstallDetails(){
		String install = "Create a directory quake3 in the root of your sdcard and also create a baseq3 directory inside it."+
							"Copy all .pk3 files from the game you want to install to the quake3/baseq3 directory." +
							"The game is now installed, run the engine, if your game doesn't load check the mods section in the in game menu";
		return install;
	}
