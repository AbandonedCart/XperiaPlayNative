...
public class PlayerPreferences {
	...
	public void populateDefaults(){
		...
		defaultPreferences.put("Crouch", Arrays.asList("On", "50", "50", ""+(screenWidth-150), ""+50, ""+defaultAlpha));
		defaultPreferences.put("Y", Arrays.asList("On", "30", "45", ""+30, ""+30, ""+defaultAlpha));
