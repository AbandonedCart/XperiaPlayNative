...
public class PlayerPreferences {
	...
	public boolean isXperiaPlay(){
		...
		if (model.equals("R800i")){
			result = true;
		}
		else if (model.equals("SEMC Xperia Play")){
			result = true;
		}
		else if (model.equals("R800x")){
			result = true;
		}
		else if (model.equals("R800a")){
			result = true;
		}
		else if (model.equals("R800at")){
			result = true;
		}
		else if (model.equals("zeus")){
			result = true;
		}
		return result;
	}
	...
	public void populateDefaults(){
		...
		if (isXperiaPlay()){
			defaultPreferences.put("Scheme", Arrays.asList("None"));
		}
		else{
