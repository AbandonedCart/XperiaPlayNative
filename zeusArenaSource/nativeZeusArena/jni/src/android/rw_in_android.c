...
void quake2_jni_move_event(int mode,
	...
	/*__android_log_print(ANDROID_LOG_DEBUG, "rw_in_android.c",
					"quake2_jni_move_event mode= %d forwardmove= %d  sidemove= %d  upmove= %d yaw= %.0f pitch = %.0f roll = %.0f\n", mode,forwardmove,sidemove,upmove, yaw, pitch,roll);*/
...
void RW_IN_Move(usercmd_t *cmd){
	...
	/*__android_log_print(ANDROID_LOG_DEBUG, "rw_in_android.c",
				"RW_IN_Move forwardmove= %d yaw= %.0f pitch = %.0f\n", event.forwardmove, event.yaw, event.pitch);*/
