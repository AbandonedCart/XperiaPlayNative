...
jstring EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2GetVersion(JNIEnv* env, jobject thiz)
{
...
jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2Init( JNIEnv* env,
                                                  jobject thiz )
{
...
jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2Frame(JNIEnv* env, jobject thiz)
{
	int 	time, newtime;
...
jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2Paused(JNIEnv* env, jobject thiz){
    // from qcommon.h
...
jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2Quit(JNIEnv* env, jobject thiz){
	//Sys_Quit();
	CL_Shutdown ();
	Qcommon_Shutdown ();
...
jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2Test(JNIEnv* env, jobject thiz){
	return 0;
}

jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2GetDisableScreen(JNIEnv* env, jobject thiz){
	extern int quake2_jni_disable_screen();
	return quake2_jni_disable_screen();
}

jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2GetVibration(JNIEnv* env, jobject thiz){
...
void EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2SetWidth(JNIEnv* env, jobject thiz, jint value){
	width = value;
}

void EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2SetHeight(JNIEnv* env, jobject thiz, jint value){
	height = value;
}
...
void EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2SetOverlay(JNIEnv* env, jobject thiz, jint value)
{
...
void EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2KeyEvent(JNIEnv* env, jclass obj, jint key, jint down){
	quake2_jni_key_event( key, down );
}

void EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2MoveEvent(JNIEnv * env, jclass obj, jint mode, jint forwardmove, jint sidemove, jint upmove, jfloat pitch, jfloat yaw, jfloat roll){
	/*__android_log_print(ANDROID_LOG_DEBUG, "quake2-jni.c",
			"Quake2MoveEvent forwardmove= %d yaw= %.0f pitch = %.0f\n", forwardmove, yaw, pitch);*/
	jint test = 15;
...
jint EXPORT_ME
JNICALL Java_quake_two_android_Quake2_Quake2PaintAudio( JNIEnv* env, jobject thiz, jobject buf ){
